  ...
  return (
    <div className="min-h-screen bg-black-50 flex flex-col justify-center items-center">
      ...
      >
        ...
        <button
          type="submit"
          className="px-6 py-2 rounded-lg bg-primary text-white font-medium shadow-md hover:bg-blue-700 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-primary"
        >
          결과 보기
        </button>
      </form>
